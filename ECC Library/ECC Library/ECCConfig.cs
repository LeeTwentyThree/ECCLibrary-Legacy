...
namespace ECCLibrary
{
    ...
    public class ECCConfig : ConfigFile
    {
        ...
        /// </summary>
        [Slider("ECC Master volume", 0f, 100f, Step = 1f, DefaultValue = 50f, Tooltip = "This is the volume for all audio in mods that require ECC. Independent from other sound settings.\nRESTART REQUIRED.")]
